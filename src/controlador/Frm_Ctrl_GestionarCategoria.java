...
public class Frm_Ctrl_GestionarCategoria {
    ...
    public Frm_Ctrl_GestionarCategoria() {
    
    }
    
    public Frm_Ctrl_GestionarCategoria(InterGestionarCategoria vista) {
        this.vista = vista;
        init();
    }
    ...
    private void jtxt_nombreCategoriaKeyPressed(java.awt.event.KeyEvent evt) {                                                
