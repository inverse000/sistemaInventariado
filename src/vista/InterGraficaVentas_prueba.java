...
import controlador.Frm_Ctrl_HistorialVentas;
 ...
 * @author Edison
 */
public class InterGraficaVentas_prueba extends javax.swing.JInternalFrame {
    ...
    //Constructor
    public InterGraficaVentas_prueba() {
        initComponents();
    ...
    private int MetodoContador() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    ...
                    + "where fechaVenta BETWEEN '" + Frm_Ctrl_HistorialVentas.fecha_inicio + "' and '" + Frm_Ctrl_HistorialVentas.fecha_fin + "' group by fechaVenta;");
